...
<form role="form" class="w-1/3 mx-auto" action="/change-password" method="post" data-content=".pc-message">
    <div class="pc-message text-gray-900 dark:text-gray-200 mb-3"></div>
    <?= csrf() ?>
    <!-- Form Group -->
    <div>
        <label for="password" class="block text-sm mb-2 dark:text-white"><?=lang("password")?></label>
        <div class="relative">
            <input type="password" id="password" name="password" class="py-3 px-4 block border shadow-sm transition-all focus:outline-blue-700 w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400" required aria-describedby="password-error">
