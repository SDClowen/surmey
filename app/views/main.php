                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <ul class="ml-10 flex items-baseline space-x-4">
                                ...
                                <li><a class="transition-colors duration-300 transform text-gray-100 hover:bg-blue-900 hover:text-white rounded-md px-3 py-2 text-sm font-medium d-flex"
                                        aria-current="page" href="/" live="true" data-content="#container"
                                        spinner="false">Dashboard</a></li>
                                <li><a class="transition-colors duration-300 transform text-gray-100 hover:bg-blue-900 hover:text-white rounded-md px-3 py-2 text-sm font-medium"
                                        href="/surveys" live="true" data-content="#container"
                                        spinner="false">Surveys</a></li>
                                <li><a class="transition-colors duration-300 transform text-gray-100 hover:bg-blue-900 hover:text-white rounded-md px-3 py-2 text-sm font-medium"
                                        href="/settings" live="true" data-content="#container"
                                        spinner="false">Settings</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    ...
                    <div class="mt-3 space-y-1 px-2">
                        <a class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white"
                            href="/settings" live="true" data-content="#container">Settings</a>
                        <a class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white"
                            href="/logout" live="true" data-content="#container">Sign out</a>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <header class="bg-white shadow-sm border-b dark:bg-slate-800 dark:border-slate-700">
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                <h1 class="flex items-center font-semibold">
                    ...
                    <span class="text-gray-500">Surmey - <small class="text-gray-400 font-thin">A simple survey
                            system</small></span>
